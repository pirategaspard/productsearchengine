 ...
 */
final class Version20190102025006 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, source_id INT NOT NULL, price INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, url VARCHAR(255) NOT NULL, url_image VARCHAR(255) DEFAULT NULL, date_last_updated DATETIME DEFAULT NULL, data LONGTEXT NOT NULL, INDEX IDX_D34A04AD953C1C61 (source_id), FULLTEXT INDEX IDX_D34A04AD5E237E06ADF3F363 (name, data), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
